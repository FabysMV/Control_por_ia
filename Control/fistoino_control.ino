...
FIS_TYPE fis_gMFI0Coeff1[] = { 45, -179 };
...
FIS_TYPE fis_gMFO0Coeff1[] = { 850, -4000 };
FIS_TYPE fis_gMFO0Coeff2[] = { 460, 1000 };
FIS_TYPE fis_gMFO0Coeff3[] = { 850, 4000 };
FIS_TYPE fis_gMFO0Coeff4[] = { 460, -1000 };
...
// Output range Min
FIS_TYPE fis_gOMin[] = { -4000 };

// Output range Max
FIS_TYPE fis_gOMax[] = { 4000 };
...
void Fuzzy(int Ytime)
{
  if (Ytime >=0){ //En función del tiempo, si este es positivo girará en sentido horario 
    H(Ytime);
